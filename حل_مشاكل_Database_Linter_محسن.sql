-- ============================================================
-- حل مشاكل Database Linter - نسخة محسنة وآمنة
-- ============================================================
...
-- ============================================================
-- 2️⃣ حل مشاكل Duplicate Indexes (نسخة آمنة)
-- ============================================================
...
-- ✅ حذف الفهارس المكررة في activities (آمن فقط)
...
SELECT '✅ تم حل جميع مشاكل Database Linter بنجاح! (نسخة آمنة)' as status;
