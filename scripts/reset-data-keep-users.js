...
async function resetDataKeepUsers() {
  console.log('🗑️ Resetting data while keeping users...\n');
  
  try {
    // Step 1: Delete all data from tables (except users)
    console.log('📊 Step 1: Deleting all data from tables (keeping users)...');
    
    // Delete in correct order (respecting foreign key constraints)
    const tables = ['kpi_records', 'boq_activities', 'projects'];
    ...
    // Step 2: Import all data from CSV files
    console.log('\n📊 Step 2: Importing all data from CSV files...');
    ...
    console.log('\n🎉 Data reset and import completed!');
...
// Run the reset
resetDataKeepUsers().catch(console.error);
