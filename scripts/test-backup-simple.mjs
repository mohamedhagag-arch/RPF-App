/**
 * 🧪 Simple Backup Test (ES Modules)
 * 
 * Usage:
 *   node scripts/test-backup-simple.mjs
 */

import 'dotenv/config'
import { createFullBackup } from '../lib/backupManager.js'
import { uploadBackupToGoogleDrive, refreshGoogleDriveToken } from '../lib/googleDriveBackup.js'
