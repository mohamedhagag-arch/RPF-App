...
export interface ProcessedKPI {
  ...
  project_code?: string // ✅ Added for compatibility
...
export function processKPIRecord(kpi: any): ProcessedKPI {
  ...
  return {
    ...
    project_code: kpi.project_code, // ✅ Added for compatibility
    activity_name: kpi.activity_name || '',
    section: kpi.section || '',
    quantity: quantity,
    input_type: inputType as 'Planned' | 'Actual',
    drilled_meters: kpi.drilled_meters || 0,
    unit: kpi.unit, // ✅ Added for compatibility
    date: kpi.date || kpi.target_date || kpi.created_at, // ✅ Added for compatibility
