...
-- Create BOQ activities table (only if it doesn't exist)
...
-- Create KPI records table (only if it doesn't exist)
...
CREATE INDEX IF NOT EXISTS idx_boq_activities_project_id ON public.boq_activities(project_id);
CREATE INDEX IF NOT EXISTS idx_boq_activities_code ON public.boq_activities(project_code);
CREATE INDEX IF NOT EXISTS idx_kpi_records_project_id ON public.kpi_records(project_id);
CREATE INDEX IF NOT EXISTS idx_kpi_records_activity_id ON public.kpi_records(activity_id);
CREATE INDEX IF NOT EXISTS idx_kpi_records_status ON public.kpi_records(status);
...
DROP POLICY IF EXISTS "Managers and admins can insert projects" ON public.projects;
DROP POLICY IF EXISTS "Managers and admins can update projects" ON public.projects;
DROP POLICY IF EXISTS "Admins can delete projects" ON public.projects;
DROP POLICY IF EXISTS "Authenticated users can view BOQ activities" ON public.boq_activities;
DROP POLICY IF EXISTS "Engineers and above can insert BOQ activities" ON public.boq_activities;
DROP POLICY IF EXISTS "Engineers and above can update BOQ activities" ON public.boq_activities;
DROP POLICY IF EXISTS "Managers and admins can delete BOQ activities" ON public.boq_activities;
DROP POLICY IF EXISTS "Authenticated users can view KPI records" ON public.kpi_records;
DROP POLICY IF EXISTS "Engineers and above can insert KPI records" ON public.kpi_records;
DROP POLICY IF EXISTS "Engineers and above can update KPI records" ON public.kpi_records;
DROP POLICY IF EXISTS "Managers and admins can delete KPI records" ON public.kpi_records;
...
DROP TRIGGER IF EXISTS update_boq_activities_updated_at ON public.boq_activities;
DROP TRIGGER IF EXISTS update_kpi_records_updated_at ON public.kpi_records;
