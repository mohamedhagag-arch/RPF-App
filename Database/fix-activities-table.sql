-- ============================================================
-- FIX ACTIVITIES TABLE - إصلاح جدول الأنشطة
-- هذا الملف يصلح المشكلة في ON CONFLICT
-- ============================================================

-- إضافة constraint فريد إذا لم يكن موجوداً
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'activities_name_division_unique'
    ) THEN
...
-- رسالة تأكيد
SELECT 'Activities table created and populated successfully!' as message;
