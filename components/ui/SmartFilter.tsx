...
interface SmartFilterProps {
  ...
  selectedActivities?: string[] // ✅ Made optional for compatibility
  selectedTypes: string[]
  selectedStatuses: string[]
  selectedDivisions?: string[] // ✅ Added for compatibility
  ...
  onDivisionsChange?: (divisions: string[]) => void // ✅ Added for compatibility
  onClearAll?: () => void // ✅ Made optional
}
...
export function SmartFilter({
  ...
  activities = [],
  selectedProjects,
  selectedActivities = [], // ✅ Made optional
  selectedTypes,
  selectedStatuses,
  selectedDivisions = [], // ✅ Added for compatibility
  onProjectsChange,
  onActivitiesChange,
  onTypesChange,
  onStatusesChange,
  onDivisionsChange = () => {}, // ✅ Added for compatibility
  onClearAll = () => {} // ✅ Made optional
}: SmartFilterProps) {
