...
interface KPICChartReportViewProps {
...
export function KPICChartReportView({ activities, projects, kpis, formatCurrency }: KPICChartReportViewProps) {
  ...
  const handleExportAllPDF = useCallback(async () => {
    ...
    if (selectedZonesForExport.size > 0) {
      activitiesToExport = activitiesToExport.filter((activityData: any) => {
  ...
  }, [selectedProject, activitiesChartData, selectedActivitiesForExport, selectedZonesForExport, cutOffDate, getActivityZone])
