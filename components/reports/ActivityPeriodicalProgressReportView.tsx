...
interface ActivityPeriodicalProgressReportViewProps {
...
export function ActivityPeriodicalProgressReportView({ 
  activities, 
  projects, 
  kpis, 
  formatCurrency 
}: ActivityPeriodicalProgressReportViewProps) {
  ...
  const prepareExportData = useMemo(() => {
    ...
    groupedData.forEach((group) => {
      ...
      exportData.push({
        ...
        'Unit': 'Unit',
        'Total': 'Total',
        'Last Period Actual': `Last ${periodType === 'weekly' ? 'Week' : periodType === 'monthly' ? 'Month' : 'Period'} Actual`,
        'Before Period Done': 'Before Period Done',
        'Current Period Planned': `${periodType === 'weekly' ? 'Current Week' : periodType === 'monthly' ? 'Current Month' : 'Current Period'} Planned`,
        'Period Done': `${periodType === 'weekly' ? 'Week' : periodType === 'monthly' ? 'Month' : 'Period'} Done`,
        'Period Done %': `${periodType === 'weekly' ? 'Week' : periodType === 'monthly' ? 'Month' : 'Period'} Done %`,
        'Cum. Planned': 'Cum. Planned',
        'Cum. Done': 'Cum. Done',
        'Cum. % Done': 'Cum. % Done',
        'Balance': 'Balance'
      })
                  ...
                  >
                    <thead>
                      <tr className="bg-gray-50 dark:bg-gray-800">
                        ...
                        <th className="border border-gray-300 dark:border-gray-600 px-3 py-2 text-right font-semibold text-gray-900 dark:text-white">
                          Last {periodType === 'weekly' ? 'Week' : periodType === 'monthly' ? 'Month' : 'Period'} Actual
                        </th>
                        <th className="border border-gray-300 dark:border-gray-600 px-3 py-2 text-right font-semibold text-gray-900 dark:text-white">
                          Before Period Done
                        </th>
                        <th className="border border-gray-300 dark:border-gray-600 px-3 py-2 text-right font-semibold text-gray-900 dark:text-white">
                          {periodType === 'weekly' ? 'Current Week' : periodType === 'monthly' ? 'Current Month' : 'Current Period'} Planned
                        </th>
                        <th className="border border-gray-300 dark:border-gray-600 px-3 py-2 text-right font-semibold text-gray-900 dark:text-white">
                          {periodType === 'weekly' ? 'Week' : periodType === 'monthly' ? 'Month' : 'Period'} Done
                        </th>
                        <th className="border border-gray-300 dark:border-gray-600 px-3 py-2 text-right font-semibold text-gray-900 dark:text-white">
                          {periodType === 'weekly' ? 'Week' : periodType === 'monthly' ? 'Month' : 'Period'} Done %
                        </th>
