  ...
  const loadSettings = async () => {
    try {
      ...
      data.forEach(setting => {
        editedMap.set(setting.setting_key, setting.setting_value)
      })
            ...
            <div className="space-y-6">
              {settings.length === 0 ? (
                ...
                settings.map((setting) => {
                  ...
                  return (
                    <div key={setting.id} className="border-b border-gray-200 dark:border-gray-700 pb-4 last:border-b-0">
