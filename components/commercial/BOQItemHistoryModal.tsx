...
interface BOQItemHistoryModalProps {
  isOpen: boolean
  onClose: () => void
  boqItemId: string
}
...
export function BOQItemHistoryModal({ isOpen, onClose, boqItemId }: BOQItemHistoryModalProps) {
  ...
  const getFieldDisplayName = (field: string): string => {
    const fieldMap: Record<string, string> = {
      ...
      'Planning Assigned Amount': 'Planning Assigned Amount',
      'Units Variation': 'Units Variation',
      'Variations Amount': 'Variations Amount',
      'Total Units': 'Total Units',
      'Total Including Variations': 'Total Including Variations',
      'Auto Generated Unique Reference Number': 'Ref Number',
    }
  ...
  const formatValue = (value: any, field: string): string => {
    ...
    if (field.includes('Amount') || field.includes('Value') || field === 'Rate') {
      ...
      <Card className="w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <CardContent className="flex-1 overflow-y-auto">
          {loading ? (
            ...
            <div className="text-center py-8">
              <p className="text-gray-500 dark:text-gray-400">No history found for this item.</p>
            </div>
          ) : (
