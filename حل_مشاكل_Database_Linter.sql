-- ============================================================
-- حل مشاكل Database Linter - تحسين الأداء
-- ============================================================
...
-- ============================================================
-- 2️⃣ حل مشاكل Duplicate Indexes
-- ============================================================

-- ✅ حذف الفهارس المكررة في BOQ Rates
...
-- ✅ حذف الفهارس المكررة في ProjectsList
DROP INDEX IF EXISTS public.idx_projects_code;
DROP INDEX IF EXISTS public.idx_projects_created;

-- ✅ حذف الفهارس المكررة في activities
-- ملاحظة: activities_name_division_unique مربوط بـ constraint
-- سنحتفظ به ونحذف الفهرس الآخر فقط
DROP INDEX IF EXISTS public.activities_name_division_key;
...
SELECT '✅ تم حل جميع مشاكل Database Linter بنجاح!' as status;
